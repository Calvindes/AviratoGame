...
export default {
    ...
    data() {
        return {
            ...
            y3: ['', '', '', ''],
            y4: ['', '', '', ''],
            turn: 0,    //0: Jugador, 1: M�quina
            mObjective: null,    //Objetivo actual de la m�quina
            msg: "�Lucha contra la m�quina!",
            victory: false
        };
    },
    ...
    methods: {
                    ...
                    case 1:
                        if (this.y1[x - 1] == '') {
                            ...
                            if (!this.checkVictory()) {
                                this.turn = 1; //turno de la m�quina
                                this.machineMove();
                            }
        ...
        machineMove() {//Movimiento de m�quina
            ...
            if (this.mObjective != false) {//Si la m�quina a�n tiene posibilidades
                ...
                switch (this.mObjective) {
                    case 'y1':
                        ...
                        if (ObjViable) {//la l�nea es viable
            ...
            } else {//Si la m�quina est� sin posibilidades
                this.msg = "�Oye!";
            }
        ...
        machineSearch() {//M�quina busca objetivo para completar
            var posibilities = ['y1', 'y2', 'y3', 'y4', 'd1', 'd2', 'x1', 'x2', 'x3', 'x4'];//Posibilidades para l�nea

            //Eliminar l�neas ocupadas
            //Y1
        ...
        reset() {
            ...
            this.mObjective = null;
            this.victory = false;
            this.msg = "�Lucha contra la m�quina!";
        }
    },
